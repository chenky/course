...
(function () {
  ...
  pageContent.addEventListener(
    ...
    function (event) {
      ...
      // const { target, clientX, clientY } = event;
      // const dragObjId = event.dataTransfer.getData("text");
      // const dragObj = document.getElementById(dragObjId);

      // if(target.id === 'dropzone2'){
      //   console.log(target)
      // }
      ...
      // target.width-dragablebox.width>left>0
      // 第一页必须top>0, 但是最后一页，top < target.width-dragablebox.height
      // 拖动框尺寸， 过程对象尺寸
